...
function OrderDetail() {
    ...
    const { orderList, getProductById, isLogin, getUserByUserId, reviewList, setReviewList } = useContext(context);
                            ...
                            orderDetail.map((product, index) => {
                                ...
                                return (
                                    <tr key={index}>
                                        <td>#{index + 1}</td>
                                        <td>
                                            <img style={{ width: '80px' }} src={getProductById(product.productId)?.image} alt="" />
                                        </td>
                                        <td>{getProductById(product.productId)?.title}</td>
